...
public class WallShield : MonoBehaviour
{
    ...
    InventoryKeyItemSelector selectedKeyItem;
    ...
    void Start()
    {
        ...
        selectedKeyItem = FindFirstObjectByType<InventoryKeyItemSelector>(FindObjectsInactive.Include);
    }
    ...
    void Update()
    {
        ...
        if (Vector2.Distance(player.transform.position, transform.position) > 15
            || selectedKeyItem.SelectionIndex != WALL_KEY_ITEM_INDEX)
        {
            Die();
        }
    }
